...
export default {
  ...
  methods: {
    loadComments () {
      axios
        .get("https://blog-nuxt-634c4.firebaseio.com/comments.json")
          .then(res => {
    ...
    changeComment(comment) {
      ...
      axios
      .put(`https://blog-nuxt-634c4.firebaseio.com/comments/${comment.id}.json`, comment)
    },
    deleteComment(id) {
      axios
      .delete(`https://blog-nuxt-634c4.firebaseio.com/comments/${id}.json`)
